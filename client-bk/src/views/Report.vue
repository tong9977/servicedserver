          ...
          <v-container px-0 py-0>
            <v-layout wrap>
              ...
              <v-tabs v-model="active" color="cyan" dark slider-color="yellow">
                <v-tab>แยกตามลูกค้า</v-tab>
                <v-tab>แยกตามพื้นที่ส่วนกลาง</v-tab>
                <v-tab>แยกตามประเภทงาน</v-tab>
                <v-tab>แยกตามช่องทางการแจ้ง</v-tab>
                <v-tab>แยกตาม RM GROUP</v-tab>
                <v-tab>แยกตามทีมช่าง</v-tab>
                <v-tab>แยกตามการประเมิน</v-tab>
                <v-tab>แยกตาม Tablet</v-tab>
                <v-tab>แยกตามสถานะ</v-tab>
                <v-tab>จัดลำดับ</v-tab>
                ...
                <v-tab-item>New แยกตามพื้นที่ส่วนกลาง</v-tab-item>
                <v-tab-item>
                  <v-card flat>
                    <v-flex md12 lg12>
                ...
                <v-tab-item>แยกตามทีมช่าง</v-tab-item>
                <v-tab-item>แยกตามการประเมิน</v-tab-item>
                <v-tab-item>แยกตาม Tablet</v-tab-item>
                <v-tab-item>แยกตามสถานะ</v-tab-item>
                <v-tab-item>จัดลำดับ</v-tab-item>
              </v-tabs>
            </v-layout>
          </v-container>
        </material-card>
