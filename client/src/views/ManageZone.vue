            ...
            <v-dialog v-model="dialog" width="500">
              ...
              <v-card>
                ...
                <v-card-text>
                  ...
                  ></v-text-field>
                  <v-text-field label="ตำแหน่ง" placeholder="กรอกตำแหน่งที่ตั้ง" v-model="Location"></v-text-field>
                  <v-text-field label="Zone Code" placeholder="กรอก Zone Code" v-model="ZoneCode"></v-text-field>
                </v-card-text>
                <v-divider></v-divider>
                <v-card-actions>
                  <v-spacer></v-spacer>
          ...
          <v-flex md12 lg12>
            ...
            >
              <e-columns>
                ...
                <e-column field="mdi-folder-edit-outline" headerText="Edit" width="160">
